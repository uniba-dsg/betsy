...
public class DeployOperation implements Serializable {
     ...
     *
     * @param bpelFileNameWithoutExtension name to set, must not be null or empty.
     */
     ...
     *
     * @param engineLogDir directory to set, must not be null or empty.
     */
     ...
     *
     * @param deploymentFile path to set, must not be null or empty
     */
