...
class ScopeProcesses {
    ...
    public final BetsyProcess COMPENSATE = builder.buildScopeProcess(
    ...
    public final BetsyProcess COMPENSATE_SCOPE = builder.buildScopeProcess(
    ...
    public final BetsyProcess SCOPE_REPEATED_COMPENSATION = builder.buildScopeProcess(
    ...
    public final BetsyProcess SCOPE_COMPLEX_COMPENSATION = builder.buildScopeProcess(
    ...
    public final BetsyProcess SCOPE_MESSAGE_EXCHANGES = builder.buildScopeProcess(
    ...
    public final BetsyProcess SCOPE_CORRELATION_SETS_INIT_ASYNC = builder.buildScopeProcess(
    ...
    public final BetsyProcess SCOPE_CORRELATION_INIT_SYNC = builder.buildScopeProcess(
    ...
    public final BetsyProcess SCOPE_EVENT_HANDLERS_ON_ALARM_FOR = builder.buildScopeProcess(
    ...
    public final BetsyProcess SCOPE_EVENT_HANDLERS_ON_ALARM_REPEAT_EVERY = builder.buildScopeProcess(
    ...
    public final BetsyProcess SCOPE_EVENT_HANDLERS_ON_ALARM_REPEAT_EVERY_FOR = builder.buildScopeProcess(
    ...
    public final BetsyProcess SCOPE_EVENT_HANDLERS_ON_ALARM_REPEAT_EVERY_UNTIL = builder.buildScopeProcess(
    ...
    public final BetsyProcess SCOPE_EVENT_HANDLERS_ON_ALARM_UNTIL = builder.buildScopeProcess(
    ...
    public final BetsyProcess SCOPE_EVENT_HANDLERS_PARTS = builder.buildScopeProcess(
    ...
    public final BetsyProcess SCOPE_EVENT_HANDLER_INIT_ASYNC = builder.buildScopeProcess(
    ...
    public final BetsyProcess SCOPE_EVENT_HANDLER_INIT_SYNC = builder.buildScopeProcess(
    ...
    public final List<BetsyProcess> SCOPE_EVENT_HANDLERS = [
    ...
    public final BetsyProcess SCOPE_EXIT_ON_STANDARD_FAULT = builder.buildScopeProcess(
    ...
    public final BetsyProcess SCOPE_EXIT_ON_STANDARD_FAULT_JOIN_FAILURE = builder.buildScopeProcess(
    ...
    public final BetsyProcess SCOPE_FAULT_HANDLERS_CATCH_ALL = builder.buildScopeProcess(
    ...
    public final BetsyProcess SCOPE_FAULT_HANDLERS_CATCH_ORDER = builder.buildScopeProcess(
    ...
    public final BetsyProcess SCOPE_FAULT_HANDLERS_FAULT_ELEMENT = builder.buildScopeProcess(
    ...
    public final BetsyProcess SCOPE_FAULT_HANDLERS_FAULT_MESSAGE_TYPE = builder.buildScopeProcess(
    ...
    public final BetsyProcess SCOPE_FAULT_HANDLERS_FAULT_VARIABLE_DATA = builder.buildScopeProcess(
    ...
    public final BetsyProcess SCOPE_FAULT_HANDLER = builder.buildScopeProcess(
    ...
    public final BetsyProcess SCOPE_FAULT_HANDLER_INVOKE = builder.buildProcessWithPartner(
    ...
    public final List<BetsyProcess> SCOPE_FAULT_HANDLERS = [
            SCOPE_FAULT_HANDLER,
    ...
    public final BetsyProcess SCOPE_PARTNER_LINKS = builder.buildProcessWithPartner(
    ...
    public final BetsyProcess SCOPE_VARIABLES = builder.buildScopeProcess(
    ...
    public final BetsyProcess SCOPE_VARIABLES_OVERWRITING = builder.buildScopeProcess(
    ...
    public final BetsyProcess SCOPE_ISOLATED = builder.buildScopeProcess(
    ...
    public final BetsyProcess SCOPE_TERMINATION_HANDLERS = builder.buildScopeProcess(
    ...
    public final BetsyProcess SCOPE_TERMINATION_HANDLERS_FAULT_NOT_PROPAGATING = builder.buildScopeProcess(
    ...
    public final BetsyProcess SCOPE_REPEATABLE_CONSTRUCT_COMPENSATION = builder.buildScopeProcess(
    ...
    public final BetsyProcess MISSING_REPLY = builder.buildScopeProcess(
    ...
    public final BetsyProcess MISSING_REQUEST = builder.buildScopeProcess(
    ...
    public final List<BetsyProcess> SCOPES = [
            COMPENSATE,
            COMPENSATE_SCOPE,
