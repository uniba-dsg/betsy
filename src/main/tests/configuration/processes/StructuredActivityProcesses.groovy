...
class StructuredActivityProcesses {
    ...
    public final BetsyProcess SEQUENCE = builder.buildStructuredActivityProcess(
    ...
    public final BetsyProcess FLOW = builder.buildStructuredActivityProcess(
    ...
    public final BetsyProcess FLOW_LINKS_RECEIVE_CREATING_INSTANCES = builder.buildStructuredActivityProcess(
    ...
    public final BetsyProcess FLOW_LINKS = builder.buildStructuredActivityProcess(
    ...
    public final BetsyProcess FLOW_LINKS_TRANSITION_CONDITION = builder.buildStructuredActivityProcess(
    ...
    public final BetsyProcess FLOW_BOUNDARY_LINKS = builder.buildStructuredActivityProcess(
    ...
    public final BetsyProcess FLOW_GRAPH_EXAMPLE = builder.buildStructuredActivityProcess(
    ...
    public final BetsyProcess FLOW_LINKS_JOIN_CONDITION = builder.buildStructuredActivityProcess(
    ...
    public final BetsyProcess FLOW_LINKS_SUPPRESS_JOIN_FAILURE = builder.buildStructuredActivityProcess(
    ...
    public final BetsyProcess FLOW_LINKS_JOIN_FAILURE = builder.buildStructuredActivityProcess(
    ...
    public final List<BetsyProcess> STRUCTURED_ACTIVITIES_FLOW = [
            FLOW,
            FLOW_LINKS,
            FLOW_BOUNDARY_LINKS,
    ...
    public final BetsyProcess IF = builder.buildStructuredActivityProcess(
    ...
    public final BetsyProcess IF_ELSE = builder.buildStructuredActivityProcess(
    ...
    public final BetsyProcess IF_ELSE_IF = builder.buildStructuredActivityProcess(
    ...
    public final BetsyProcess IF_ELSE_IF_ELSE = builder.buildStructuredActivityProcess(
    ...
    public final BetsyProcess REPEAT_UNTIL = builder.buildStructuredActivityProcess(
    ...
    public final BetsyProcess REPEAT_UNTIL_EQUALITY = builder.buildStructuredActivityProcess(
    ...
    public final BetsyProcess FOR_EACH = builder.buildStructuredActivityProcess(
    ...
    public final BetsyProcess FOR_EACH_NEGATIVE_STOP_COUNTER = builder.buildStructuredActivityProcess(
    ...
    public final BetsyProcess FOR_EACH_NEGATIVE_START_COUNTER = builder.buildStructuredActivityProcess(
    ...
    public final BetsyProcess FOR_EACH_COMPLETION_CONDITION_NEGATIVE_BRANCHES = builder.buildStructuredActivityProcess(
    ...
    public final BetsyProcess FOR_EACH_TOO_LARGE_START_COUNTER = builder.buildStructuredActivityProcess(
    ...
    public final BetsyProcess FOR_EACH_PARALLEL = builder.buildStructuredActivityProcess(
    ...
    public final BetsyProcess FOR_EACH_COMPLETION_CONDITION = builder.buildStructuredActivityProcess(
    ...
    public final BetsyProcess FOR_EACH_COMPLETION_CONDITION_PARALLEL = builder.buildStructuredActivityProcess(
    ...
    public final BetsyProcess FOR_EACH_COMPLETION_CONDITION_SUCCESSFUL_BRANCHES_ONLY = builder.buildStructuredActivityProcess(
    ...
    public final BetsyProcess FOR_EACH_COMPLETION_CONDITION_FAILURE = builder.buildStructuredActivityProcess(
    ...
    public final List<BetsyProcess> STRUCTURED_ACTIVITIES_FOR_EACH = [
            FOR_EACH,
    ...
    public final BetsyProcess PICK_CORRELATIONS_INIT_SYNC = builder.buildStructuredActivityProcess(
    ...
    public final BetsyProcess PICK_CREATE_INSTANCE = builder.buildStructuredActivityProcess(
    ...
    public final BetsyProcess PICK_ON_ALARM_UNTIL = builder.buildStructuredActivityProcess(
    ...
    public final BetsyProcess PICK_ON_ALARM_FOR = builder.buildStructuredActivityProcess(
    ...
    public final List<BetsyProcess> STRUCTURED_ACTIVITIES_PICK = [
    ...
    public final List<BetsyProcess> STRUCTURED_ACTIVITIES = [
            SEQUENCE,
            WHILE,
            REPEAT_UNTIL,
