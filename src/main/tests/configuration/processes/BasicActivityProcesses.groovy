...
class BasicActivityProcesses {
    ...
    public final BetsyProcess EMPTY = builder.buildBasicActivityProcess(
    ...
    public final BetsyProcess EXIT = builder.buildBasicActivityProcess(
    ...
    public final BetsyProcess VARIABLES_UNINITIALIZED_VARIABLE_FAULT_REPLY = builder.buildBasicActivityProcess(
    ...
    public final BetsyProcess WAIT_FOR_INVALID_EXPRESSION_VALUE = builder.buildBasicActivityProcess(
    ...
    public final BetsyProcess WAIT_UNTIL = builder.buildBasicActivityProcess(
    ...
    public final List<BetsyProcess> BASIC_ACTIVITIES_WAIT = [
            WAIT_FOR,
            WAIT_FOR_INVALID_EXPRESSION_VALUE,
            WAIT_UNTIL
    ]

    public final BetsyProcess THROW = builder.buildBasicActivityProcess(
    ...
    public final BetsyProcess THROW_WITHOUT_NAMESPACE = builder.buildBasicActivityProcess(
    ...
    public final BetsyProcess THROW_CUSTOM_FAULT = builder.buildBasicActivityProcess(
    ...
    public final BetsyProcess THROW_CUSTOM_FAULT_IN_WSDL = builder.buildBasicActivityProcess(
    ...
    public final BetsyProcess THROW_FAULT_DATA = builder.buildBasicActivityProcess(
    ...
    public final BetsyProcess RETHROW = builder.buildBasicActivityProcess(
            "Rethrow",
    ...
    public final BetsyProcess RETHROW_FAULT_DATA_UNMODIFIED = builder.buildBasicActivityProcess(
    ...
    public final BetsyProcess RETHROW_FAULT_DATA = builder.buildBasicActivityProcess(
            "Rethrow-FaultData",
    ...
    public final List<BetsyProcess> BASIC_ACTIVITIES_THROW = [
            THROW,
    ...
    public final BetsyProcess RECEIVE = builder.buildBasicActivityProcess(
    ...
    public final BetsyProcess RECEIVE_AMBIGUOUS_RECEIVE_FAULT = builder.buildBasicActivityProcess(
    ...
    public final BetsyProcess RECEIVE_CONFLICTING_RECEIVE_FAULT = builder.buildBasicActivityProcess(
    ...
    public final BetsyProcess RECEIVE_REPLY_CONFLICTING_REQUEST_FAULT = builder.buildBasicActivityProcess(
    ...
    public final BetsyProcess RECEIVE_REPLY_CORRELATION_VIOLATION_YES = builder.buildBasicActivityProcess(
    ...
    public final BetsyProcess RECEIVE_REPLY_FROM_PARTS = builder.buildBasicActivityProcess(
    ...
    public final BetsyProcess RECEIVE_REPLY_FAULT = builder.buildBasicActivityProcess(
    ...
    public final List<BetsyProcess> BASIC_ACTIVITIES_RECEIVE = [
            RECEIVE,
    ...
    public final BetsyProcess INVOKE_CATCH_UNDECLARED_FAULT = builder.buildProcessWithPartner(
    ...
    public final BetsyProcess INVOKE_CATCHALL_UNDECLARED_FAULT = builder.buildProcessWithPartner(
    ...
    public final List<BetsyProcess> BASIC_ACTIVITIES_INVOKE = [
            INVOKE_ASYNC,
            INVOKE_SYNC,
            INVOKE_SYNC_FAULT,
            INVOKE_EMPTY,
    ...
    public final BetsyProcess ASSIGN_MISMATCHED_ASSIGNMENT_FAILURE = builder.buildBasicActivityProcess(
    ...
    public final BetsyProcess ASSIGN_LITERAL = builder.buildBasicActivityProcess(
    ...
    public final BetsyProcess ASSIGN_EXPRESSION_FROM = builder.buildBasicActivityProcess(
    ...
    public final BetsyProcess ASSIGN_EXPRESSION_TO = builder.buildBasicActivityProcess(
    ...
    public final BetsyProcess ASSIGN_SELECTION_FAILURE = builder.buildBasicActivityProcess(
    ...
    public final BetsyProcess ASSIGN_COPY_QUERY = builder.buildBasicActivityProcess(
    ...
    public final BetsyProcess ASSIGN_COPY_KEEP_SRC_ELEMENT_NAME = builder.buildBasicActivityProcess(
    ...
    public final BetsyProcess ASSIGN_COPY_IGNORE_MISSING_FROM_DATA = builder.buildBasicActivityProcess(
    ...
    public final BetsyProcess ASSIGN_COPY_GET_VARIABLE_PROPERTY = builder.buildBasicActivityProcess(
    ...
    public final List<BetsyProcess> BASIC_ACTIVITIES_ASSIGN = [
            ASSIGN_VALIDATE,
            ASSIGN_PROPERTY,
            ASSIGN_PARTNERLINK,
    ...
    public final List<BetsyProcess> BASIC_ACTIVITIES = [
