...
class ActivityProcesses {
    ...
    */
    ...
    public static final Test CALL_ACTIVITY_PROCESS = BPMNProcessBuilder.buildActivityProcess("CallActivity_Process",
            ...
            new BPMNTestCaseBuilder().assertMarkerExists().assertTask2());

    public static final Test CALL_ACTIVITY_GLOBAL_TASK = BPMNProcessBuilder.buildActivityProcess("CallActivity_GlobalTask",
    ...
    public static final Test MULTI_INSTANCE_SUBPROCESS = BPMNProcessBuilder.buildActivityProcess("MultiInstance_SubProcess",
    ...
    public static final Test MULTI_INSTANCE_TASK = BPMNProcessBuilder.buildActivityProcess("MultiInstance_Task",
    ...
    public static final Test MULTI_INSTANCE_SEQUENTIAL = BPMNProcessBuilder.buildActivityProcess("MultiInstance_Sequential",
    ...
    public static final Test MULTI_INSTANCE_NONE_BEHAVIOR = BPMNProcessBuilder.buildActivityProcess("MultiInstance_NoneBehavior",
            ...
            new BPMNTestCaseBuilder().assertTask1().assertTask3().assertTask1().assertTask3().assertTask1().assertTask3().assertTask2());

    public static final Test MULTI_INSTANCE_ONE_BEHAVIOR = BPMNProcessBuilder.buildActivityProcess("MultiInstance_OneBehavior",
            ...
            new BPMNTestCaseBuilder().assertTask1().assertTask3().assertTask1().assertTask1().assertTask2());

    public static final Test MULTI_INSTANCE_ALL_BEHAVIOR = BPMNProcessBuilder.buildActivityProcess("MultiInstance_AllBehavior",
    ...
    public static final Test MULTI_INSTANCE_COMPLEX_BEHAVIOR = BPMNProcessBuilder.buildActivityProcess("MultiInstance_ComplexBehavior",
    ...
    public static final Test MULTI_INSTANCE_PARALLEL = BPMNProcessBuilder.buildActivityProcess("MultiInstance_Parallel",
    ...
    public static final Test LOOP_SUBPROCESS = BPMNProcessBuilder.buildActivityProcess("Loop_SubProcess",
            ...
            new BPMNTestCaseBuilder().setIntegerVariable(3).assertIncrement().assertTask1(), new BPMNTestCaseBuilder().setIntegerVariable(1).assertIncrement().assertIncrement().assertTask1(), new BPMNTestCaseBuilder().setIntegerVariable(0).assertIncrement().assertIncrement().assertIncrement().assertTask1());

    public static final Test LOOP_TASK = BPMNProcessBuilder.buildActivityProcess("Loop_Task",
            ...
            new BPMNTestCaseBuilder().setIntegerVariable(3).assertIncrement().assertTask2(), new BPMNTestCaseBuilder().setIntegerVariable(1).assertIncrement().assertIncrement().assertTask2(), new BPMNTestCaseBuilder().setIntegerVariable(0).assertIncrement().assertIncrement().assertIncrement().assertTask2());

    public static final Test LOOP_CONDITION_ONLY = BPMNProcessBuilder.buildActivityProcess("Loop_ConditionOnly",
            "A scriptTask with standardLoopCharacteristics which should be looped as long as 'integerVariable' is less than 3. "
                    + "Each time the task is executed 'INCREMENT' is logged. "
                    + "The default for the attribute 'testBefore' is used, which is 'false', i.e., the loopCondition is "
                    + "evaluated after the execution (do-while semantics). "
    ...
    public static final Test LOOP_MAXIMUM = BPMNProcessBuilder.buildActivityProcess("Loop_Maximum",
    ...
    public static final Test LOOP_NO_ITERATION_TEST_BEFORE_FALSE = BPMNProcessBuilder.buildActivityProcess("Loop_NoIteration_TestBeforeFalse",
    ...
    public static final Test LOOP_NO_ITERATION_TEST_BEFORE_TRUE = BPMNProcessBuilder.buildActivityProcess("Loop_NoIteration_TestBeforeTrue",
    ...
    public static final Test SUB_PROCESS = BPMNProcessBuilder.buildActivityProcess("SubProcess",
            "A process that contains a subProcess",
            new Feature(CONSTRUCT_SUBPROCESS, "SubProcess"),
            new BPMNTestCaseBuilder().assertTask1().assertTask2());

    public static final Test TRANSACTION = BPMNProcessBuilder.buildActivityProcess("Transaction",
            "A process that contains a transaction",
            new Feature(CONSTRUCT_TRANSACTION, "Transaction"),
            new BPMNTestCaseBuilder().assertTask1().assertTask2());

    public static final Test AD_HOC_SUB_PROCESS_SEQUENTIAL = BPMNProcessBuilder.buildActivityProcess("AdHocSubProcess_Sequential",
    ...
    public static final Test AD_HOC_SUB_PROCESS_PARALLEL = BPMNProcessBuilder.buildActivityProcess("AdHocSubProcess_Parallel",
    ...
    public static final Test TOKEN_CARDINALITY_EXPLICIT = BPMNProcessBuilder.buildActivityProcess("Token_Cardinality_Explicit",
            ...
            new BPMNTestCaseBuilder().assertTask1().assertTask2().assertTask2().assertTask3());

    public static final Test TOKEN_CARDINALITY_DEFAULT = BPMNProcessBuilder.buildActivityProcess("Token_Cardinality_Default",
    ...
    public static final Test TOKEN_CARDINALITY_SPLIT_DEFAULT = BPMNProcessBuilder.buildActivityProcess("Token_Cardinality_Split_Default",
            ...
            new BPMNTestCaseBuilder().assertTask1().assertTask2().assertTask3().assertTask4().assertTask4());

    public static final Test TOKEN_CARDINALITY_SPLIT_EXPLICIT = BPMNProcessBuilder.buildActivityProcess("Token_Cardinality_Split_Explicit",
            "A process that contains one scriptTask which has two outgoing sequence flows, each leading to one of two forwarding scriptTasks. " +
            ...
            new BPMNTestCaseBuilder().assertTask1().assertTask2().assertTask3().assertTask4());

    public static final Test SEND_TASK = BPMNProcessBuilder.buildActivityProcess("SendTask",
            ...
            new BPMNTestCaseBuilder().useParallelProcess().assertTask1().assertMarkerExists());

    public static final Test RECEIVE_TASK = BPMNProcessBuilder.buildActivityProcess("ReceiveTask",
            "A test with two processes, which start in parallel. " +
    ...
    public static final Test RECEIVE_TASK_INSTANTIATE = BPMNProcessBuilder.buildActivityProcess("ReceiveTask_Instantiate",
            ...
            new BPMNTestCaseBuilder().assertTask1().assertMarkerExists());


    public static final List<Test> ACTIVITIES = Arrays.asList(
