...
class TaskProcesses {
    ...
    public static final BPMNProcess MULTI_INSTANCE_TASK_SEQUENTIAL = builder.buildTaskProcess(
    ...
    public static final BPMNProcess MULTI_INSTANCE_TASK_NONE_BEHAVIOR = builder.buildTaskProcess(
    ...
    public static final BPMNProcess MULTI_INSTANCE_TASK_ONE_BEHAVIOR = builder.buildTaskProcess(
    ...
    public static final BPMNProcess MULTI_INSTANCE_TASK_ALL_BEHAVIOR = builder.buildTaskProcess(
    ...
    public static final BPMNProcess MULTI_INSTANCE_TASK_PARALLEL = builder.buildTaskProcess(
    ...
    public static final BPMNProcess LOOP_TASK_LOOP_MAXIMUM = builder.buildTaskProcess(
