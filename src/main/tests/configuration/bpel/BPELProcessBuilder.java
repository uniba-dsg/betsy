...
public class BPELProcessBuilder {
    ...
    public static BPELProcess buildProcess(final String name, BPELTestCase... testCases) {
        BPELProcess process = new BPELProcess();
    ...
    public static BPELProcess buildProcessWithXsd(final String name, BPELTestCase... testCases) {
        BPELProcess process = new BPELProcess();
        process.setProcess(PATH_PREFIX.resolve(name + FileTypes.BPEL));
        process.setWsdls(new ArrayList<>(Collections.singletonList(testInterface)));
        process.setTestCases(Arrays.asList(testCases));
    ...
    public static BPELProcess buildProcessWithPartner(final String name, BPELTestCase... testCases) {
        BPELProcess process = new BPELProcess();
        process.setProcess(PATH_PREFIX.resolve(name + FileTypes.BPEL));
        process.setWsdls(new ArrayList<>(Arrays.asList(testInterface, partnerInterface)));
        process.setTestCases(Arrays.asList(testCases));
    ...
    public static BPELProcess buildProcessWithXslt(final String name, BPELTestCase... testCases) {
        BPELProcess process = new BPELProcess();
        process.setProcess(PATH_PREFIX.resolve(name + FileTypes.BPEL));
        process.setWsdls(new ArrayList<>(Arrays.asList(testInterface, partnerInterface)));
        process.setTestCases(Arrays.asList(testCases));
    ...
    public static BPELProcess buildProcessWithXsd(String name, String description, BPELTestCase... testCases) {
        BPELProcess process = buildProcessWithXsd(name, testCases);
        process.setDescription(description);
        return process;
    }

    public static BPELProcess buildProcessWithPartner(String name, String description, BPELTestCase... testCases) {
        BPELProcess process = buildProcessWithPartner(name, testCases);
        process.setDescription(description);
        return process;
    }

    public static BPELProcess buildProcessWithXslt(String name, String description, BPELTestCase... testCases) {
