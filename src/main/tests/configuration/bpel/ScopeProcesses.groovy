...
class ScopeProcesses {
    ...
    public static final BPELProcess COMPENSATE = builder.buildScopeProcess(
    ...
    public static final BPELProcess COMPENSATE_FLOW = builder.buildScopeProcess(
    ...
    public static final BPELProcess COMPENSATE_SCOPE = builder.buildScopeProcess(
    ...
    public static final BPELProcess SCOPE_REPEATED_COMPENSATION = builder.buildScopeProcess(
    ...
    public static final BPELProcess SCOPE_COMPLEX_COMPENSATION = builder.buildScopeProcess(
    ...
    public static final BPELProcess SCOPE_MESSAGE_EXCHANGES = builder.buildScopeProcess(
    ...
    public static final BPELProcess SCOPE_MULTIPLE_MESSAGE_EXCHANGES = builder.buildScopeProcess(
    ...
    public static final BPELProcess SCOPE_CORRELATION_SETS_INIT_ASYNC = builder.buildScopeProcess(
    ...
    public static final BPELProcess SCOPE_CORRELATION_INIT_SYNC = builder.buildScopeProcess(
    ...
    public static final BPELProcess SCOPE_EVENT_HANDLERS_ON_ALARM_FOR = builder.buildScopeProcess(
    ...
    public static final BPELProcess SCOPE_EVENT_HANDLERS_ON_ALARM_REPEAT_EVERY = builder.buildScopeProcess(
    ...
    public static final BPELProcess SCOPE_EVENT_HANDLERS_ON_ALARM_REPEAT_EVERY_FOR = builder.buildScopeProcess(
    ...
    public static final BPELProcess SCOPE_EVENT_HANDLERS_ON_ALARM_REPEAT_EVERY_UNTIL = builder.buildScopeProcess(
    ...
    public static final BPELProcess SCOPE_EVENT_HANDLERS_ON_ALARM_UNTIL = builder.buildScopeProcess(
    ...
    public static final BPELProcess SCOPE_EVENT_HANDLERS_PARTS = builder.buildScopeProcess(
    ...
    public static final BPELProcess SCOPE_EVENT_HANDLER_ASYNC_INIT_SYNC = builder.buildScopeProcess(
    ...
    public static final BPELProcess SCOPE_EVENT_HANDLER_INIT_ASYNC = builder.buildScopeProcess(
    ...
    public static final BPELProcess SCOPE_EVENT_HANDLER_INIT_SYNC = builder.buildScopeProcess(
    ...
    public static final BPELProcess SCOPE_EVENT_HANDLER_FLOW_INIT_ASYNC = builder.buildScopeProcess(
    ...
    public static final BPELProcess SCOPE_EVENT_HANDLER_FLOW_INIT_SYNC = builder.buildScopeProcess(
    ...
    public static final BPELProcess SCOPE_EVENT_HANDLER_MESSAGE_EXCHANGE_INIT_ASYNC = builder.buildScopeProcess(
    ...
    public static final BPELProcess SCOPE_EVENT_HANDLER_MESSAGE_EXCHANGE_INIT_SYNC = builder.buildScopeProcess(
    ...
    public static final BPELProcess SCOPE_EVENT_HANDLER_SCOPE_MESSAGE_EXCHANGE_INIT_ASYNC = builder.buildScopeProcess(
    ...
    public static final BPELProcess SCOPE_EVENT_HANDLER_INTERNAL_MESSAGE_EXCHANGE_INIT_ASYNC = builder.buildScopeProcess(
    ...
    public static final BPELProcess SCOPE_EVENT_HANDLER_INTERNAL_MESSAGE_EXCHANGE_INIT_SYNC = builder.buildScopeProcess(
    ...
    public static final BPELProcess SCOPE_EVENT_HANDLER_SCOPE_MESSAGE_EXCHANGE_INIT_SYNC = builder.buildScopeProcess(
    ...
    public static final BPELProcess SCOPE_EVENT_HANDLER_FILO_MESSAGE_EXCHANGES = builder.buildScopeProcess(
    ...
    public static final BPELProcess SCOPE_EVENT_HANDLER_FILO_MESSAGE_EXCHANGES_PICK = builder.buildScopeProcess(
    ...
    public static final BPELProcess SCOPE_EVENT_HANDLER_ELEMENT_INIT_ASYNC = builder.buildScopeProcess(
    ...
    public static final BPELProcess SCOPE_EVENT_HANDLER_ELEMENT_INIT_SYNC = builder.buildScopeProcess(
    ...
    public static final List<BPELProcess> SCOPES_EVENT_HANDLERS = [
    ...
    public static final BPELProcess SCOPE_EXIT_ON_STANDARD_FAULT = builder.buildScopeProcess(
    ...
    public static final BPELProcess SCOPE_EXIT_ON_STANDARD_FAULT_JOIN_FAILURE = builder.buildScopeProcess(
    ...
    public static final BPELProcess SCOPE_FAULT_HANDLERS_CATCH_ALL = builder.buildScopeProcess(
    ...
    public static final BPELProcess SCOPE_FAULT_HANDLERS_CATCH_ALL_INVOKE_VALIDATE = builder.buildProcessWithPartner(
    ...
    public static final BPELProcess SCOPE_FAULT_HANDLERS_OUTBOUND_LINK_CATCH_ALL = builder.buildScopeProcess(
    ...
    public static final BPELProcess PROCESS_FAULT_HANDLERS_CATCH_ORDER = builder.buildScopeProcess(
    ...
    public static final BPELProcess SCOPE_FAULT_HANDLERS_CATCH_ORDER = builder.buildScopeProcess(
    ...
    public static final BPELProcess PROCESS_FAULT_HANDLERS_FAULT_ELEMENT = builder.buildScopeProcess(
    ...
    public static final BPELProcess SCOPE_FAULT_HANDLERS_FAULT_ELEMENT = builder.buildScopeProcess(
    ...
    public static final BPELProcess SCOPE_FAULT_HANDLERS_FAULT_MESSAGE_TYPE = builder.buildScopeProcess(
    ...
    public static final BPELProcess SCOPE_FAULT_HANDLERS_FAULT_VARIABLE_DATA = builder.buildScopeProcess(
    ...
    public static final BPELProcess SCOPE_FAULT_HANDLER = builder.buildScopeProcess(
    ...
    public static final BPELProcess SCOPE_FAULT_HANDLER_OUTBOUND_LINK = builder.buildScopeProcess(
    ...
    public static final List<BPELProcess> SCOPES_FAULT_HANDLERS = [
            SCOPE_FAULT_HANDLER,
    ...
    public static final BPELProcess SCOPE_PARTNER_LINKS = builder.buildProcessWithPartner(
    ...
    public static final BPELProcess SCOPE_VARIABLES = builder.buildScopeProcess(
    ...
    public static final BPELProcess SCOPE_VARIABLES_OVERWRITING = builder.buildScopeProcess(
    ...
    public static final BPELProcess SCOPE_ISOLATED = builder.buildScopeProcess(
    ...
    public static final BPELProcess SCOPE_TERMINATION_HANDLERS = builder.buildScopeProcess(
    ...
    public static final BPELProcess SCOPE_TERMINATION_HANDLERS_OUTBOUND_LINK = builder.buildScopeProcess(
    ...
    public static final BPELProcess SCOPE_TERMINATION_HANDLERS_FAULT_NOT_PROPAGATING = builder.buildScopeProcess(
    ...
    public static final BPELProcess SCOPE_REPEATABLE_CONSTRUCT_COMPENSATION = builder.buildScopeProcess(
    ...
    public static final BPELProcess MISSING_REPLY = builder.buildScopeProcess(
            "MissingReply", "A receive for a synchronous operation with no associated reply.",
            [
                    new BPELTestCase().checkDeployment().sendSync(1, new SoapFaultTestAssertion(faultString: "missingReply"))
            ]
    )

    public static final BPELProcess MISSING_REQUEST = builder.buildScopeProcess(
            ...
            [
                    new BPELTestCase().checkDeployment().sendSync(1, new SoapFaultTestAssertion(faultString: "missingRequest"))
            ]
    )

    public static final List<BPELProcess> SCOPES = [
            COMPENSATE,
            COMPENSATE_FLOW,
            COMPENSATE_SCOPE,
