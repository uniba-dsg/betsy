...
class StructuredActivityProcesses {
    ...
    public static final BPELProcess FLOW_LINKS_JOIN_FAILURE = builder.buildStructuredActivityProcess(
            ...
            new BPELTestCase().checkDeployment().sendSync(1, new SoapFaultTestAssertion(faultString: "joinFailure")),
            new BPELTestCase().checkDeployment().sendSync(3, new SoapFaultTestAssertion(faultString: "joinFailure")),
    )
    ...
    public static
    final BPELProcess FLOW_STARTING_RECEIVE_ON_MESSAGE_CORRELATION = builder.buildStructuredActivityProcess(
    ...
    public static final BPELProcess IF = builder.buildStructuredActivityProcess(
            ...
            new BPELTestCase(name: "If-Case").checkDeployment().sendSync(2, 1)
    )
    ...
    public static final BPELProcess IF_ELSE_IF = builder.buildStructuredActivityProcess(
            ...
            new BPELTestCase(name: "If-Case").checkDeployment().sendSync(2, 1),
            new BPELTestCase(name: "ElseIf-Case").checkDeployment().sendSync(3, 2),
    )
    ...
    public static
    final BPELProcess IF_SUBLANGUAGE_EXECUTION_FAULT_EMPTY_CONDITION = builder.buildStructuredActivityProcess(
    ...
    public static final BPELProcess FOR_EACH = builder.buildStructuredActivityProcess(
            ...
            new BPELTestCase(name: "0plus1-equals-0").checkDeployment().sendSync(1, 1),
    ...
    public static
    final BPELProcess FOR_EACH_COMPLETION_CONDITION_NEGATIVE_BRANCHES = builder.buildStructuredActivityProcess(
    ...
    public static final BPELProcess FOR_EACH_COMPLETION_CONDITION = builder.buildStructuredActivityProcess(
            ...
            new BPELTestCase(name: "Cannot meet completion condition").checkDeployment().
    ...
    public static
    final BPELProcess FOR_EACH_COMPLETION_CONDITION_SUCCESSFUL_BRANCHES_ONLY = builder.buildStructuredActivityProcess(
