...
public class Containers {
     ...
     * @param containerName The name of the {@link Container}
     * @param imageName     The name of the image
     * @param cpuShares     The relative weight of cpu.
     * @param memory        The value of the memory.
     * @param hddSpeed      The speed of the hdd.
     * @param args          Optional arguments for the creation.
     * @return Returns the created {@link Container}.
     */
    public static Container create(DockerMachine dockerMachine, String containerName, String imageName, int cpuShares, int memory, int hddSpeed, String... args) {
        Objects.requireNonNull(dockerMachine, "The dockerMachine can't be null.");
        Objects.requireNonNull(containerName, "The containerName can't be null.");
        Objects.requireNonNull(imageName, "The imageName can't be null.");
        String[] commands = {"create", containerName, String.valueOf(cpuShares), String.valueOf(hddSpeed), String.valueOf(memory), imageName};
        String[] cmds = new String[args.length + commands.length];
        System.arraycopy(commands, 0, cmds, 0, commands.length);
        System.arraycopy(args, 0, cmds, commands.length, args.length);
        String id = null;
     ...
     * @return Returns the created {@link Container}.
     */
    public static Container run(DockerMachine dockerMachine, String containerName, String imageName, int cpuShares, int memory, int hddSpeed, String... args) {
        Objects.requireNonNull(dockerMachine, "The dockerMachine can't be null.");
        Objects.requireNonNull(containerName, "The containerName can't be null.");
        Objects.requireNonNull(imageName, "The imageName can't be null.");
        String[] commands = {"run", containerName, String.valueOf(cpuShares), String.valueOf(hddSpeed), String.valueOf(memory), imageName};
        String[] cmds = new String[args.length + commands.length];
        System.arraycopy(commands, 0, cmds, 0, commands.length);
        System.arraycopy(args, 0, cmds, commands.length, args.length);
        String nextLine = null;
