...
public class Camunda760Engine extends Camunda720Engine {

    @Override
    public EngineExtended getEngineObject() {
        return new EngineExtended(ProcessLanguage.BPMN, "camunda", "7.6.0", LocalDate.of(2016, 11, 30), "Apache-2.0");
    }
    ...
    public void install() {
        ...
        camundaInstaller.setFileName("camunda-bpm-tomcat-7.6.0.zip");
