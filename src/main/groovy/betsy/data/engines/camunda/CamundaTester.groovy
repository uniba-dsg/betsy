...
class CamundaTester {
    ...
    void runTest(){
        ...
        JSONObject response = get(restURL + "/process-definition?key=approve-loan")
        ...
        response = get(restURL + "/variable-instance?processInstanceIdIn=${processInstanceId}&variableName=amount")
