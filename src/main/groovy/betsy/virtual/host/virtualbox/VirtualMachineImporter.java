...
public class VirtualMachineImporter {
     ...
     *
     * @throws ArchiveException  thrown if the Archive is corrupted or did not contain the
     *                           required data
     * @throws DownloadException thrown if the download failed
     */
    ...
    private URL getDownloadAddress() throws URIException, MalformedURLException {
        String address = Configuration.getValueAsString("virtual.engines." + engineName + ".download");
     ...
     * @throws ArchiveContentException thrown if there was either none or there were more than one
     *                                 appliance files
     */
